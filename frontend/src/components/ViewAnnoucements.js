...
const ViewAnnoucements = ({ club, showChat, setShowChat }) => {
  ...
  if (checkAdmin) {
    const tep = JSON.parse(checkAdmin);
    if (tep.isAdmin === true) {
      isAdmin = true;
    }
  }
  ...
  console.log('isamdifg', isAdmin)
  return (
    <div className="ml-[25rem] text-black w-[60vw] mt-20 m-8 font-semibold border-2 rounded-md">
      <ToastContainer
        position="top-right"
        autoClose={2000}
